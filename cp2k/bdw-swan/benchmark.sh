...
case "$COMPILER" in
    ...
    gcc-7.3)
        ...
        export LD=ftn
        export CFLAGS=""
        export FCFLAGS="-O3 -fopenmp -march=broadwell -funroll-loops -ffast-math -ftree-vectorize -ffree-form -ffree-line-length-512"
        MKL_COMP="gf"
        LIBSCI_COMP="gnu_71"
        ;;
    intel-2018)
        ...
        export LD=ftn
        export CFLAGS=""
        export FCFLAGS="-O3 -fopenmp -xCORE-AVX2 -heap-arrays -fpp -free -nofor_main"
        MKL_COMP="intel"
        LIBSCI_COMP="intel"
        ;;

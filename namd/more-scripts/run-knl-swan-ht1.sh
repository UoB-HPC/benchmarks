...
aprun -d "$numprocs" -j 1 -cc depth numactl -m 1 ./NAMD-2.12-KNL-Intel-18-charm-6.8.2-cray-fftw-3.3.6.3/namd2 "+p$numprocs" stmv/stmv.namd +setcpuaffinity |& tee "$runlog"

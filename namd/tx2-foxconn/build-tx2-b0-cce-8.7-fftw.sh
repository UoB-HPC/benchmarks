...
install_dir="${1:-$PWD/NAMD-2.12-TX2-CCE-8.7.0-charm-6.8.2-cray-fftw-3.3.6.3}"
...
./build charm++ "$charmarch" cce --with-production --destination="$charm_install_dir/$charmarch" -j16
...
sed -i 's,^FFTDIR=.*,FFTDIR='"/opt/cray/pe/fftw/$CRAY_FFTW_VERSION/arm_thunderx2," "arch/${namd_target%-cce}.fftw3"

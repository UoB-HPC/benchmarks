...
basedir="$PWD/OpenFOAM-v1712-TX2-GCC-8.1.0-OpenMPI-3.0.0"
...
bashrc="etc/bashrc"
cppflags="wmake/rules/linuxARM64Gcc/c++"
cppoptflags="wmake/rules/linuxARM64Gcc/c++Opt"

...
testdir="run/block_DrivAer_small-tx2-ht2"
numprocs=128
...
mpirun --mca btl vader,self --map-by ppr:2:core --use-hwthread-cpus --report-bindings -np "$numprocs" simpleFoam -parallel |& tee "$runlog"
